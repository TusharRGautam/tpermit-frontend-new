...
const DashboardHome: React.FC = () => {
  ...
  const handleSimulateSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await leadService.simulateWebhookLead(payload);
    ...
    <div className="dashboard-home-container">
      <div className="dashboard-welcome-banner">
        <div className="welcome-content">
          ...
          <p>Manage your quotations, bookings, payments, and more from one central place</p>
        </div>
      </div>

      {/* Meta Campaign Leads Section */}
        ...
        <div className="leads-section-header">
          <div className="leads-header-title">
            <h2>
              ...
              <span className="sync-text">Live Syncing</span>
            </h2>
          </div>
        ...
        <div className="leads-simulator-drawer">
          ...
          <div className="leads-simulator-body">
            <p className="leads-simulator-description">
              ...
              This triggers the backend webhook, which will process the lead and save it in Supabase, updating the dashboard below in real-time.
            </p>

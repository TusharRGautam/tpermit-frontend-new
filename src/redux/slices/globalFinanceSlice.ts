...
const initialState: GlobalFinanceState = {
  globalBankOptions: [
    ...
    {
      globalBankId: 'mahindra',
      globalBankName: 'Mahindra Finance',
      globalInterestRate: 9.0,
      globalProcessingFee: 20000,
      globalMaxLoanAmount: 8500000,
      globalMinDownPayment: 20,
      globalMaxTenure: 96,
    },
    {
      globalBankId: 'cholamandalam',
      globalBankName: 'Cholamandalam Bank',
      globalInterestRate: 9.2,
      globalProcessingFee: 19000,
      globalMaxLoanAmount: 8000000,
      globalMinDownPayment: 22,
      globalMaxTenure: 84,
    },
  ],
